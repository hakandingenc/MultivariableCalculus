\section{Mathematical Notation}
	...
	\[
		\Set{1,2,3}
	\]
	would be read aloud as ``the set containing the elements $1$, $2$, and $3$.''
	...
	and is written $\varnothing$ or $\Set{}$.  Note that $\Set{\varnothing}$ is \emph{not}
	...
	\begin{example}
		...
		$m=2(n-1)+1$ is, by definition, an even number.  Therefore $x\in B$.
	...
	\begin{align*}
		\varnothing &= \Set{}\text{, the empty set}\\
